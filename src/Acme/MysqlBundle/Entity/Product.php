 ...
 * })
 * @ORM\Entity(repositoryClass="Acme\MysqlBundle\Repository\ProductRepository")
 */
class Product extends BaseEntity
{
    /**
     * @Gedmo\Slug(fields={"name", "position"})
    ...
    {
        $this->category = is_object($category) ? $category->getId() : $category;
